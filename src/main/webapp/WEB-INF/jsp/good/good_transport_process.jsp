...
<div id="meetingTb" style="padding-top:0px">
    ...
    <a id="search" style="margin-left: 20px;" href="#" class="easyui-linkbutton"
       data-options="iconCls:'icon-search'">查询</a>
</div>

<div id="detailWin" class="easyui-window" title="查看货物详情" modal="true" data-options="iconCls:'icon-save'"
     style="top:20px;width:420px;height:320px;padding-top:20px;" closed="true">
    <table align="center" width="400" border="0" cellspacing="20">
        <tr>
            ...
            <td><input style="height:30px;width:200px;font-size:20px" type="text" name="goodDetailName"
                       id="goodDetailName"/></td>
        </tr>
        <tr>
            <th align="right"><span style="font-size:16px">尺寸:</span></th>
            <td><input style="height:30px;width:200px;font-size:20px" type="text" name="goodDetailSize"
                       id="goodDetailSize"/></td>
        </tr>
        <tr>
            <th align="right"><span style="font-size:16px">重量:</span></th>
            <td><input style="height:30px;width:200px;font-size:20px" type="text" name="goodDetailWeight"
                       id="goodDetailWeight"/></td>
        </tr>
        <tr>
            <th align="right"><span style="font-size:16px">数量:</span></th>
            <td><input style="height:30px;width:200px;font-size:20px" type="text" name="goodDetailAmount"
                       id="goodDetailAmount"/></td>
        </tr>
        <tr>
            <th align="right"><span style="font-size:16px">货物单价:</span></th>
            <td><input style="height:30px;width:200px;font-size:20px" type="text" name="goodDetailValue"
                       id="goodDetailValue"/></td>
        </tr>
    </table>
</div>

<div id="imgWindow" class="easyui-window" title="货物图片" modal="true" data-options="iconCls:'icon-save'"
     style="top:0px;width:550px;height:500px;padding:5px;" closed="true">

</div>

<div id="updatetp" class="easyui-window" title="更新货物运输详情" modal="true" data-options="iconCls:'icon-save'"
     style="top:20px;width:600px;height:360px;padding-top:20px;" closed="true">
    <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addpositions()"
       style="margin-left: 450px;">添加地理位置</a>
    <table id="tb" align="center" width="550" border="0" cellspacing="20">
        <tr>
            ...
            <td><input style="height:30px;width:300px;font-size:20px" type="text" name="goodOrderNumber"
                       id="goodOrderNumbers"/></td>
        </tr>
        <tr>
            <th align="right" style="margin-right:20px"><span style="font-size:16px">当前的位置:</span></th>
            <td><input style="height:30px;width:300px;font-size:20px" type="text" name="goodTransportProcessPosition"
                       id="goodTransportProcessPosition" placeholder="输入所经过的城市"/></td>
        </tr>

    </table>
    <div style="margin-top:50px;margin-bottom:50px">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="margin-right:100px;margin-left:100px"
           onclick="saveposition()">确定</a>
        <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
           onclick="$('#updatetp').window('close')">取消</a>
    </div>
</div>
...
<div id="situationwindow" class="easyui-window" title="物流情况" modal="true" data-options="iconCls:'icon-save'"
    ...
    <div style="margin-top:30px">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="margin-right:100px;margin-left:180px"
           onclick="Savetime()">确定</a>
        <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
           onclick="$('#situationwindow').window('close')">取消</a>
    </div>
...
<script type="text/javascript">
    ...
    function Savetime() {
        ...
        var json = {};
        var goodTransportInformationList = [];
        for (var i = 0; i < lengths; i++) {
            var Array = {};
            ...
            Array.date = dates;
            goodTransportInformationList.push(Array);
        }
        json.goodTransportInformationList = goodTransportInformationList;
        json.orderNumber = goodOrderNumber;
        console.log(json);
        $.ajax({
            type: "POST",
            traditional: true,
            ...
            // updateGoodTransportInformation:json
