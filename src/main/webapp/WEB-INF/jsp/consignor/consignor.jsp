...
<body class="easyui-layout">
	...
	<div id="meetingTb" style="padding-top:0px">
		...
		<span style="margin-left:20px">名字 ：&nbsp<span><input id="sConsignorName" type="text" style="width:70px;"/>
    ...
    <script type="text/javascript">
		...
		$("#meeting").datagrid({
			width:1195,
			url:"${proPath }" + '/express/consignor/getConsignorList',
			title:'货主列表',
			columns:[[
				{field:'consignorId',title:'货主id',width:20},
				{field:'consignorName',title:'货主姓名',width:25},
				{field:'consignorPhone',title:'货主手机',width:35},
				{field:'consignorAddress',title:'地址',width:35},
				{field:'consignorSex',title:'性别',width:35}
			]],
			pagination:true,
			fitColumns:true,
			toolbar:"#meetingTb",
	...
	$("#search").click(function(){
		var consignorName  = $("#sConsignorName").val();
